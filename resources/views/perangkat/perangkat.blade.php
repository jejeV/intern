        ...
        <div class="col-6 p-3 d-flex justify-content-end">
            <div class="me-2">
                <div class="d-flex flex-wrap me-2 justify-content-end">
                    {{-- Search --}}
                    <form action="{{ url('/perangkat') }}" method="GET" class="me-2 me-lg-3" id="formSearch">
...
{{-- Modal Create --}}
<form method="POST" action="{{ url('perangkat') }}" id="formCreate">
    @csrf
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col mb-lg-2 mb-1">
                                <label for="nameWithTitle" class="form-label">Perangkat</label>
                                <input type="text" name="perangkat" value="{{ $perangkat->perangkat }}" id="nameWithTitle"
                                    class="form-control" placeholder="Nama Perangkat" />
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
