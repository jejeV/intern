                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                              <div class="me-2">
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#modalCenter3-{{ $row->id }}">
                          ...
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                  <div class="col mb-lg-2 mb-1">
                                    <label for="nameWithTitle" class="form-label">daop</label>
                                    <input type="text" name="daop" value="{{ $stasiun->daop }}" id="nameWithTitle" class="form-control" placeholder="Enter Name" autofocus disabled/>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-6 mb-lg-2 mb-1">
                                    <label for="nameWithTitle" class="form-label">nama stasiun</label>
                                    <input type="text" name="nama_stasiun" value="{{ $stasiun->nama_stasiun }}" id="nameWithTitle" class="form-control" placeholder="Enter Name" disabled/>
                                  </div>
                                  <div class="col-6 mb-lg-2 mb-1">
                                    <label for="nameWithTitle" class="form-label">kodkod</label>
                                    <input type="text" name="kodkod" value="{{ $stasiun->kodkod }}" id="nameWithTitle" class="form-control" placeholder="Enter Name" disabled/>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col mb-lg-2 mb-1">
                                    <label for="nameWithTitle" class="form-label">kmtsta</label>
                                    <input type="text" name="kmtsta" value="{{ $stasiun->kmtsta }}" id="nameWithTitle" class="form-control" placeholder="Enter Name" disabled/>
                                  </div>
                                  <div class="col mb-lg-2 mb-1">
                                    <label for="nameWithTitle" class="form-label">line</label>
                                    <input type="text" name="line" value="{{ $stasiun->line }}" id="nameWithTitle" class="form-control" placeholder="Enter Name" disabled/>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col mb-lg-2 mb-1">
                                    <label for="nameWithTitle" class="form-label">remark</label>
                                    <input type="text" name="remark" value="{{ $stasiun->remark }}" id="nameWithTitle" class="form-control" placeholder="Enter Name" disabled/>
                                  </div>
                                  <div class="col mb-lg-2 mb-1">
                                    <label for="nameWithTitle" class="form-label">rel aktif no bb</label>
                                    <input type="text" name="rel_aktif_no_bb" value="{{ $stasiun->rel_aktif_no_bb }}" id="nameWithTitle" class="form-control" placeholder="Enter Name" disabled/>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col mb-lg-2 mb-1">
                                    <label for="nameWithTitle" class="form-label">ring</label>
                                    <input type="text" name="ring" id="nameWithTitle" value="{{ $stasiun->ring }}" class="form-control" placeholder="Enter Name" disabled/>
                                  </div>
                                  <div class="col mb-lg-2 mb-1">
                                    <label for="nameWithTitle" class="form-label">segmen</label>
                                    <input type="text" name="segmen" id="nameWithTitle" value="{{ $stasiun->segmen }}" class="form-control" placeholder="Enter Name" disabled/>
                                  </div>
                                </div>
                              </div>
                              <div class="modal-footer">
